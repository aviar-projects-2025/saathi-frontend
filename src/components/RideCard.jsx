...
export default function RideCard({ ride }) {
  ...
  const detailItems = isFlight
    ...
    : [
      { label: "Date & time", icon: <CalendarTodayIcon sx={iconSx} />, value: `${dateStr}${timeStr ? " · " + timeStr : ""}` },
      { label: "Seats available", icon: <EventSeatIcon sx={iconSx} />, value: `${ride.availableSeats || 0} seat${ride.availableSeats === 1 ? "" : "s"}` },
  ...
  return (
    <>
      <Box sx={{ mb: 2, mx: { xs: 0.5, sm: 0 }, maxWidth: 1000, width: "100%" }}>
